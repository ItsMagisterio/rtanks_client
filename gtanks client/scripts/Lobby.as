package 
{
    ...
    import projects.tanks.client.panel.model.ITopModelBase;
    ...
    public class Lobby implements INetworkListener 
    {
            ...
            switch (data.type)
            {
                case Type.LOBBY_CHAT:
                    if (data.args[0] == "system")
                    {
                        ...
                        this.chat.chatModel.chatPanel.addMessage("", 0, data.args[1], 0, "", true, ((data.args[2] == "yellow") ? this.yellowColor : this.greenColor));
                    }
                    else
                    {
                        if (data.args[0] == "init_chat")
                        {
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        {
                                                                            if (data.args[0] == "remove_player_from_battle")
                                                                            {
                                                                                parser = JSON.parse(data.args[1]);
                                                                                if (parser.battleId != this.battleSelect.battleSelectModel.selectedBattleId)
                                                                                {
                                                                            ...
                                                                            {
                                                                                if (data.args[0] == "server_message")
                                                                                {
                                                                                    Main.debug.showServerMessageWindow(data.args[1]);
                                                                                }
                                                                                else
                                                                                {
                                                                                    if (data.args[0] == "show_bonuses")
                                                                                    {
                                                                                        this.bonusModel.showBonuses(data.args[1]);
                                                                                    }
                                                                                    else
                                                                                    {
                                                                                        if (data.args[0] == "show_no_supplies")
                                                                                        {
                                                                                            this.bonusModel.showNoSupplies();
                                                                                        }
                                                                                        else
                                                                                        {
                                                                                            if (data.args[0] == "show_double_crystalls")
                                                                                            {
                                                                                                this.bonusModel.showDoubleCrystalls();
                                                                                            }
                                                                                            else
                                                                                            {
                                                                                                if (data.args[0] == "show_crystalls")
                                                                                                {
                                                                                                ...
                                                                                                else
                                                                                                {
                                                                                                    ...
                                                                                                    else
                                                                                                    {
                                                                                                        ...
                                                                                                        {
                                                                                                            if (data.args[0] == "init_battlecontroller")
                                                                                                            {
                                                                                                                    ...
                                                                                                                    else
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        else
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            else
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                {
                                                                                                                                    if (data.args[0] == "set_reamining_time")
                                                                                                                                    {
                                                                                                                                        this.itemEffectModel.setRemaining(data.args[1], data.args[2]);
                                                                                                                                    }
                                                                                                                                    else
                                                                                                                                    {
                                                                                                                                        if (data.args[0] == "show_news")
                                                                                                                                        {
                                                                                                                                            parser = JSON.parse(data.args[1]);
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            if (data.args[0] == "show_quests")
                                                                                                                                            {
                                                                                                                                                parser = JSON.parse(data.args[1]);
                                                                                                                                                questsModel = (Main.osgi.getService(IChallenge) as ChallengeModel);
                                                                                                                                                progress = new UserProgressServerData();
                                                                                                                                                progress.level = parser.current_level;
                                                                                                                                                progress.targetProgress = parser.target_progress;
                                                                                                                                                progress.progress = parser.progress;
                                                                                                                                                quests = new Array();
                                                                                                                                                for each (q in parser.quests)
                                                                                                                                                {
                                                                                                                                                    quest = new ChallengeServerData();
                                                                                                                                                    quest.description = q.description;
                                                                                                                                                    quest.level = q.level;
                                                                                                                                                    prizes = new Array();
                                                                                                                                                    for each (p in q.prizes)
                                                                                                                                                    {
                                                                                                                                                        prizes.push(p);
                                                                                                                                                    };
                                                                                                                                                    quest.prizes = prizes;
                                                                                                                                                ...
                                                                                                                                                questsModel.show(progress, quests);
                                                                                                                                            }
                                                                                                                                            else
                                                                                                                                            {
                                                                                                                                                if (data.args[0] == "show_achievements")
                                                                                                                                                {
                                                                                                                                                    achievementModel = (Main.osgi.getService(IAchievementModel) as AchievementModel);
                                                                                                                                                    parser = JSON.parse(data.args[1]);
                                                                                                                                                ...
                                                                                                                                                {
                                                                                                                                                    if (data.args[0] == "complete_achievement")
                                                                                                                                                    {
                                                                                                                                                        achievementModel = (Main.osgi.getService(IAchievementModel) as AchievementModel);
                                                                                                                                                    ...
                                                                                                                                                    {
                                                                                                                                                        if (data.args[0] == "update_rating_data")
                                                                                                                                                        {
                                                                                                                                                        ...
                                                                                                                                                        {
                                                                                                                                                            if (data.args[0] == "show_gifts_window")
                                                                                                                                                            {
                                                                                                                                                                parser = JSON.parse(data.args[1]);
                ...
                case Type.GARAGE:
                    ...
                    {
                        if (data.args[0] == "init_market")
                        {
                            this.parseMarket(data.args[1]);
                        }
                        else
                        {
                            if (data.args[0] == "mount_item")
                            {
                                ...
                                {
                                    if (oldItem.itemType == ItemTypeEnum.WEAPON)
                                    {
                                        idOldItem = this.garage.garageModel.mountedWeaponId;
                                    }
                                    else
                                    {
                                        if (oldItem.itemType == ItemTypeEnum.COLOR)
                                        {
                            ...
                            else
                            {
                                if (data.args[0] == "update_item")
                                {
                                    ...
                                    this.garage.garageModel.upgradeItem(null, this.garage.garageModel.currentItemForUpdate, GarageModel.getItemInfo(this.getNextId(data.args[1])));
                                }
                                else
                                {
                                    if (data.args[0] == "init_mounted_item")
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            if (data.args[0] == "remove_item_from_market")
                                            {
        ...
        private function parseChatMessages(json:String):void
        {
            ...
            for each (obj in parser.messages)
            {
                ...
                msg.sysCollor = ((obj.yellow) ? this.yellowColor : this.greenColor);
                msgs.push(msg);
                userTo = null;
            };
        ...
        private function parseBattleInfo(json:String):void
        {
            ...
            this.battleSelect.battleSelectModel.showBattleInfo(null, obj.name, obj.maxPeople, BattleType.getType(obj.type), obj.battleId, obj.previewId, obj.minRank, obj.maxRank, obj.timeLimit, obj.timeCurrent, obj.killsLimit, obj.scoreRed, obj.scoreBlue, obj.autobalance, obj.frielndyFie, users, obj.paidBattle, obj.withoutBonuses, obj.userAlreadyPaid, obj.fullCash, obj.spectator);
        ...
        {
            var parser:Object = JSON.parse(json);
            this.chat.chatModel.chatPanel.addMessage(parser.name, parser.rang, parser.message, parser.rangTo, ((parser.nameTo == "NULL") ? "" : parser.nameTo), parser.system);
        }

        public function parseAndInitHallOfFame(json:String):void
        {
            var u:Object;
            var achiviments:String;
            var achArray:Array;
            var ach:Object;
            var temp:User;
            ...
            var parser:Object = JSON.parse(json);
            var place:int;
            var maxRowHeigth:int = 20;
            for each (u in parser.users)
            {
                achiviments = "";
                achArray = u.awards;
                for each (ach in achArray)
                {
                    achiviments = (achiviments + (ach + "\n"));
                };
                if (achArray.length > (maxRowHeigth / 20))
                {
                    maxRowHeigth = (achArray.length * 20);
                };
                achiviments = achiviments.substring(0, (achiviments.length - 1));
                temp = new User(u.userName, achiviments, 0, u.rank, place, 0, 0, 0, 0, u.userRating);
                array.push(temp);
                place++;
            };
            (Main.osgi.getService(ITopModelBase) as TopModel).openTop(null, array.length, maxRowHeigth);
            this.initHallOfFame(array);
            this.battleSelect.battleSelectModel.hideList();
        }

        public function initHallOfFame(array:Array):void
        {
            var top:TopModel = TopModel(Main.osgi.getService(ITopModelBase));
            top.setTopData(null, array);
            top.objectLoaded(Game.getInstance.classObject);
        }
