package alternativa.physics
{
   ...
   public class Body
   {
      ...
      public function applyRelPosWorldImpulse(r:Vector3, dir:Vector3, magnitude:Number) : void
      {
         ...
         this.state.rotation.x += this.invInertiaWorld.a * x + this.invInertiaWorld.b * y + this.invInertiaWorld.c * z;
         this.state.rotation.y += this.invInertiaWorld.e * x + this.invInertiaWorld.f * y + this.invInertiaWorld.g * z;
         this.state.rotation.z += this.invInertiaWorld.i * x + this.invInertiaWorld.j * y + this.invInertiaWorld.k * z;
      }
      ...
      {
         this.state.velocity.x += this.accel.x * dt;
         this.state.velocity.y += this.accel.y * dt;
         this.state.velocity.z += this.accel.z * dt;
         this.state.rotation.x += this.angleAccel.x * dt;
         this.state.rotation.y += this.angleAccel.y * dt;
         this.state.rotation.z += this.angleAccel.z * dt;
      ...
      {
         this.state.pos.x += this.state.velocity.x * dt;
         this.state.pos.y += this.state.velocity.y * dt;
         this.state.pos.z += this.state.velocity.z * dt;
