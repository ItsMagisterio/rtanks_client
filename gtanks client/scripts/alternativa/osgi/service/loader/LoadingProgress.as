package alternativa.osgi.service.loader
{
   ...
   public class LoadingProgress
   {
      ...
      {
         return this.progressData[processId] != null ? LoadingProgressData(this.progressData[processId]).status : "";
      }
      
      public function getProgress(processId:Object) : Number
      {
         return Number(this.progressData[processId] != null ? Number(LoadingProgressData(this.progressData[processId]).progress) : Number(0));
      }
   }
}
