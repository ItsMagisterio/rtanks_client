package alternativa.tanks.models.battlefield.gui.statistics.table
{
   ...
   public class ViewStatistics extends Sprite
   {
      ...
      public function ViewStatistics(type:int, localUserId:String, finish:Boolean)
      {
      ...
      public function updatePlayer(id:Object, name:String, rank:int, kills:int, deaths:int, score:int, reward:int) : void
      {
