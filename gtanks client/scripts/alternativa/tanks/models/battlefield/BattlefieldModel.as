package alternativa.tanks.models.battlefield
{
    ...
    import scpacker.test.bots.debug.DebugWindow;
    ...
    public class BattlefieldModel extends BattlefieldModelBase implements IBattlefieldModelBase, IBattleField, IObjectLoadListener, IBonusListener, INetworkListener, IPanelListener, IBodyCollisionPredicate, IDumper, ITankEventListener 
    {
		...
		[Embed(source="SNOW_DUST_DATA.png")]
        private static const SNOW_DUST_DATA:Class;
		[Embed(source="DUST_DATA.png")]
		...
		[Embed(source = "sk_def.webp", mimeType = "application/octet-stream")]
        private var sk_def:Class;
		[Embed(source = "sk_des.webp", mimeType = "application/octet-stream")]
        private var sk_des:Class;
		[Embed(source = "sk_iran.webp", mimeType = "application/octet-stream")]
        private var sk_iran:Class;
		[Embed(source = "sk_iran_winter.webp", mimeType = "application/octet-stream")]
        private var sk_iran_winter:Class;
		[Embed(source = "sk_halloween.webp", mimeType = "application/octet-stream")]
        private var sk_halloween:Class;
		[Embed(source = "sk_winter.webp", mimeType = "application/octet-stream")]
        private var sk_winter:Class;
		[Embed(source = "sk_plato.webp", mimeType = "application/octet-stream")]
        private var sk_plato:Class;
		[Embed(source = "sk_new_year.webp", mimeType = "application/octet-stream")]
        private var sk_new_year:Class;
		[Embed(source = "sk_winter_evening.webp", mimeType = "application/octet-stream")]
        private var sk_winter_evening:Class;
		[Embed(source = "sk_evening.webp", mimeType = "application/octet-stream")]
        private var sk_evening:Class;
		[Embed(source = "sk_space.webp", mimeType = "application/octet-stream")]
        private var sk_space:Class;
		[Embed(source = "sk_rio.webp", mimeType = "application/octet-stream")]
        private var sk_rio:Class;
		[Embed(source = "sk_rio_night.webp", mimeType = "application/octet-stream")]
        private var sk_rio_night:Class;
        ...
        public function objectUnloaded(clientObject:ClientObject):void
        {
            ...
            {
                botModel.destroy();
                DebugWindow.INSTANCE.removeFromStage();
            };
            var i:int;
        ...
        private function initPhysicsAndViewport():void
        {
            ...
            if (this.gameMode == GameModes.SPACE)
            {
                ...
                {
                    physics.gravity = new Vector3(0, 0, -100);
                };
            }
            else
            {
        ...
        {
            this.bfData.viewport.addDecal(param1, param2, param3, param4, param5);
        }
        ...
        {
            var skyBoxTexture:BitmapData;
            switch (skyboxId)
            {
                case "skybox_default":
                    skyBoxTexture = WebpSwc.decode((new this.sk_def() as ByteArray));
                    break;
                case "skybox_desert":
                    skyBoxTexture = WebpSwc.decode((new this.sk_des() as ByteArray));
                    break;
                case "skybox_iran":
                    skyBoxTexture = WebpSwc.decode((new this.sk_iran() as ByteArray));
                    break;
                case "skybox_iran_winter":
                    skyBoxTexture = WebpSwc.decode((new this.sk_iran_winter() as ByteArray));
                    break;
                case "skybox_halloween":
                    skyBoxTexture = WebpSwc.decode((new this.sk_halloween() as ByteArray));
                    break;
                case "skybox_winter":
                    skyBoxTexture = WebpSwc.decode((new this.sk_winter() as ByteArray));
                    break;
                case "skybox_plato":
                    skyBoxTexture = WebpSwc.decode((new this.sk_plato() as ByteArray));
                    break;
                case "skybox_new_year":
                    skyBoxTexture = WebpSwc.decode((new this.sk_new_year() as ByteArray));
                    break;
                case "skybox_winter_evening":
                    skyBoxTexture = WebpSwc.decode((new this.sk_winter_evening() as ByteArray));
                    break;
                case "skybox_evening":
                    skyBoxTexture = WebpSwc.decode((new this.sk_evening() as ByteArray));
                    break;
                case "skybox_space":
                    skyBoxTexture = WebpSwc.decode((new this.sk_space() as ByteArray));
                    break;
				case "skybox_rio":
				   skyBoxTexture = WebpSwc.decode(new this.sk_rio() as ByteArray);
				   break;
				case "skybox_rio_night":
				   skyBoxTexture = WebpSwc.decode(new this.sk_rio_night() as ByteArray);
				   break;
                default:
                    skyBoxTexture = new StubBitmapData(0xFF0000);
            };
        ...
        private function loop(e:Event):void
        {
            ...
            if (this.adaptiveFpsEnabled)
            {
                if (++this.adaptiveFrameCounter == ADAPTIVE_FPS_CHANGE_INTERVAL)
                {
                    ...
                    {
                        Main.stage.frameRate = ((this.fullTimeStat.avrgFps < MIN_FRAMERATE) ? MIN_FRAMERATE : this.fullTimeStat.avrgFps);
                    }
                    else
                    {
                        fps = (Main.stage.frameRate + 1);
                        Main.stage.frameRate = ((fps > MAX_FRAMERATE) ? MAX_FRAMERATE : fps);
                    };
                    if (this.debugPanel.visible)
                    {
        ...
        {
            this.screenSize = ((size > this.screenSizeSteps) ? this.screenSizeSteps : ((size < 1) ? 1 : size));
            var storage:IStorageService = (Main.osgi.getService(IStorageService) as IStorageService);
