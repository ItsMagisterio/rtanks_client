      ...
      public function update(time:int, deltaTime:int) : Number
      {
         ...
         if(this.active)
         {
            ...
            else
            {
               ...
               {
                  this.nextTickTime.value += this.localGunData.tickPeriod.value;
                  if(this.currTarget != null)
                  {
               ...
               this.currentCharge -= 0.001 * (time - this.lastUpdateTime.value) * this.localGunData.dischargeRate.value;
               if(this.currentCharge < 0)
               {
         ...
         {
            this.currentCharge += 0.001 * (time - this.lastUpdateTime.value) * this.localGunData.chargeRate.value;
