package alternativa.tanks.models.weapon.plasma
{
   ...
   public class PlasmaModel extends PlasmaModelBase implements IPlasmaModelBase, IObjectLoadListener, IPlasmaShotListener, IWeaponController
   {
      ...
      public function hit(clientObject:ClientObject, firingTankId:String, shotId:int, affectedPoint:Vector3d, affectedTankId:String, weakeningCoeff:Number) : void
      {
         ...
         if(affectedPoint == null || isNaN(affectedPoint.x) || isNaN(affectedPoint.y) || isNaN(affectedPoint.z))
         {
            return;
         }
      ...
      public function plasmaShotHit(shot:PlasmaShot, hitPoint:Vector3, hitDir:Vector3, body:Body) : void
      {
         ...
         if(affectedTankData != null)
         {
            ...
            this.hitCommand(shot.shooterData.turret,shot.shotId,this._hitPos3d,affectedTankData.user.id,affectedTankData.incarnation,this._tankPos3d,distance,shot.shooterData);
         }
         else
         {
            this.hitCommand(shot.shooterData.turret,shot.shotId,this._hitPos3d,null,-1,null,distance,shot.shooterData);
      ...
      private function hitCommand(turrObj:ClientObject, shotId:int, hitPos:Vector3d, affectedTankId:String, incr:int, tankPos:Vector3d, distance:int, shooter:TankData) : void
      {
         var js:Object = new Object();
         js.shotId = shotId;
         js.hitPos = hitPos;
      ...
      public function createShot(active:Boolean, shotId:int, tankData:TankData, muzzleGlobalPos:Vector3, dirToTarget:Vector3) : void
      {
