package alternativa.tanks.models.weapon.shaft.sfx
{
   ...
   public class ShaftSFXModel implements ShaftSFX
   {
      ...
      public function createMuzzleFlashEffect(turretObj:ClientObject, param1:Vector3, param2:Object3D) : void
      {
         ...
         this.createLightMuzzleFlashEffect(turretObj,param1,param2);
      }
      
      public function createLightMuzzleFlashEffect(turretObj:ClientObject, param1:Vector3, param2:Object3D) : void
      {
         var bfModel:BattlefieldModel = Main.osgi.getService(IBattleField) as BattlefieldModel;
      ...
      private function createEffectsForPoint(turretObject:ClientObject, owner:ClientObject, sfxData:ShaftSFXData, param1:Vector3, param2:Vector3, param3:Vector3, param4:Vector3, param5:Boolean) : void
      {
         ...
         this.createExplosionLightEffect(turretObject,param1);
      }
      
      private function createExplosionLightEffect(turretObject:ClientObject, param1:Vector3) : void
      {
         var bfModel:BattlefieldModel = Main.osgi.getService(IBattleField) as BattlefieldModel;
