    ...
    public class ParaBonus implements IBonus, ICollisionPredicate {
        ...
        public function attach(pos:Vector3, rigidWorld:PhysicsScene, container:Scene3DContainer, listener:IBonusListener):void{
            ...
            if (this.bonusState == BonusState.FALLING){
				...
				this.startSpawnAnimation(container);
		 ...
		 private function startSpawnAnimation(container:Scene3DContainer):void
        {
            var animation:SpawnAnimation = SpawnAnimation(BattlefieldModel(Main.osgi.getService(IBattleField)).getObjectPool().getObject(SpawnAnimation));
        ...
        public function update(param1:int, param2:int, param3:Number):Boolean{
			...
			this.alpha = (this.alpha + (0.0005 * param2));
            if (this.alpha > 1){
                this.alpha = 1;
            };
            ...
            if (((this.bonusState == BonusState.RESTING) && (this.landingControllerInited))){
                _loc4_ = 0;
                while (_loc4_ < this.landingPrecision) {
            ...
            if (this.parachuteTimeLeft > 0){
                this.parachuteTimeLeft = (this.parachuteTimeLeft - param2);
                if (this.parachuteTimeLeft <= 0){
                    ...
                    this.parachute.z = (this.parachute.z - ((this.fallSpeed / 2000) * param2));
        ...
        private function removeParachuteGraphics():void{
            if (this.parachute != null){
                var _local_1:* = this.parachute;
                (_local_1.alternativa3d::removeFromParent());
                this.parachute.recycle();
                this.parachute = null;
            };
            if (this.cordsMesh != null){
                _local_1 = this.cordsMesh;
                (_local_1.alternativa3d::removeFromParent());
        ...
        private function playTakenAnimation(millis:int):void{
            ...
            this.skin.z = (this.skin.z + ((((UP_SPEED * this.takenAnimationTime) / TAKEN_ANIMATION_TIME) + (UP_SPEED * 0.1)) * dt));
            this.skin.rotationZ = (this.skin.rotationZ + ((((ANGLE_SPEED * this.takenAnimationTime) / TAKEN_ANIMATION_TIME) + (ANGLE_SPEED * 0.1)) * dt));
