package alternativa.tanks.models.effects.common.bonuscommon
{
   ...
   public class FallController
   {
      ...
      private static const MAX_ANGLE_X:Number = 0.2;//0.3//0.1
      
	  private static const ANGLE_X_FREQ:Number = 2.4;//3.4//1
	  
      private static const MAX_ANGLE_X_PARACHUTE:Number = 0.1;//0.15//0.1
	  
      private static const ANGLE_X_FREQ_PARACHUTE:Number = 1;//1.3//1
