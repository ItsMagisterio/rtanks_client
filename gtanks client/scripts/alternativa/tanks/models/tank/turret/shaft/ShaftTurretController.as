package alternativa.tanks.models.tank.turret.shaft
{
   ...
   public class ShaftTurretController implements TurretController
   {
      ...
      public function rotateTurret(deltaSec:Number) : void
      {
         ...
         var turretRotationDir:int = ((int(this.tankData.ctrlBits & TankModel.TURRET_LEFT) || int(this.tankData.ctrlBits & TankModel.LEFT)) >> 4) - ((int(this.tankData.ctrlBits & TankModel.TURRET_RIGHT) || int(this.tankData.ctrlBits & TankModel.RIGHT)) >> 5);
