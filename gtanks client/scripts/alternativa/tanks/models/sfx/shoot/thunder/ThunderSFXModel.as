package alternativa.tanks.models.sfx.shoot.thunder
{
   ...
   public class ThunderSFXModel extends ThunderShootSFXModelBase implements IThunderShootSFXModelBase, IThunderSFXModel
   {
      ...
      public function createShotEffects(clientObject:ClientObject, muzzleLocalPos:Vector3, turret:Object3D) : EffectsPair
      {
         ...
         this.createShotLightEffects(muzzleLocalPos,turret,clientObject);
      ...
      {
         var _loc3_:AnimatedLightEffect = null;
         var _loc4_:MuzzlePositionProvider = null;
         try
         {
            _loc3_ = AnimatedLightEffect(objectPoolService.objectPool.getObject(AnimatedLightEffect));
            _loc4_ = MuzzlePositionProvider(objectPoolService.objectPool.getObject(MuzzlePositionProvider));
         ...
         {
            Logger.info(0,"ThunderSFXModel::createShotLightEffects LightDataManager get null data");
         }
      }
      ...
      private function createExplosionLightEffect(param1:Vector3, turretObj:ClientObject) : void
      {
         ...
         try
         {
            _loc2_ = AnimatedLightEffect(objectPoolService.objectPool.getObject(AnimatedLightEffect));
            _loc3_ = StaticObject3DPositionProvider(objectPoolService.objectPool.getObject(StaticObject3DPositionProvider));
