      ...
      private function createLightEffect(param1:IsisActionType, targetData:TankData) : void
      {
         ...
         switch(param1)
         {
            ...
            case IsisActionType.HEAL:
               trace("create heal effect",targetData.turret.id,_loc2_,LightDataManager.getLightData(targetData.turret.id,"friendly_start"),LightDataManager.getLightData(targetData.turret.id,"friendly_loop"));
