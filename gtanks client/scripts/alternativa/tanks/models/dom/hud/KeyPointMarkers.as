package alternativa.tanks.models.dom.hud
{
   ...
   public class KeyPointMarkers
   {
      ...
      private function updateMarker(param1:KeyPointMarker, param2:Matrix4) : void
      {
         ...
         if(v.z > 0 && _loc5_)
         {
            _loc7_ = this.getPointAlpha(param1.point);
            if(_loc7_ == 0)
            {
               param1.visible = false;
               param1.alpha = 0;
      ...
      private function getPointAlpha(param1:Point) : Number
      {
         var _loc3_:Number = NaN;
         var _loc4_:Number = NaN;
         var _loc5_:RayIntersectionData = null;
         param1.readPos(pointPosition);
         ...
         direction.vDiff(pointPosition,cameraPosition);
         _loc4_ = direction.vLength();
         direction.normalize();
         _loc5_ = this.battleService.raycast(cameraPosition,direction,this.battleService.bfData.viewport.getExcludedObjects());
