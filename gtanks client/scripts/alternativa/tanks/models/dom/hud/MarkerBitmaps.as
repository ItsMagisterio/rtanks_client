package alternativa.tanks.models.dom.hud
{
   ...
   public class MarkerBitmaps
   {
      ...
      private static const letters_view:Class = MarkerBitmaps_letters_view;
      ...
      public static const letterBar:BitmapData = new letters().bitmapData;
      
      public static const letterViewBar:BitmapData = new letters_view().bitmapData;
