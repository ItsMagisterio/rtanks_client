package alternativa.tanks.gui
{
   ...
   public class PaymentWindow extends Sprite
   {
      ...
      {
         var _loc4_:PaymentButton = null;
         var _loc5_:DefaultButton = null;
      ...
      {
         this.bugReportWindow.removeEventListener(Event.COMPLETE,this.onBugReportComplete);
         this.bugReportWindow.removeEventListener(Event.CANCEL,this.onBugReportCancel);
         Main.stage.removeEventListener(Event.RESIZE,this.alignReportWindow);
         this.dialogsLayer.removeChild(this.bugReportWindow);
      ...
      private function onBugReportComplete(e:Event = null) : void
      {
         ...
         this.panelModel.sendBugReport("PAYMENT bug report",this.bugReportWindow.reportString);
      }
   }
}
