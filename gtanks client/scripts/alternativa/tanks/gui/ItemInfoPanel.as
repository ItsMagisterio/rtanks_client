package alternativa.tanks.gui
{
    ...
    public class ItemInfoPanel extends Sprite 
    {
        ...
        private static const bitmapCrit:Class = ItemInfoPanel_bitmapCrit;
        private static const criticalDamageBd:BitmapData = new bitmapCrit().bitmapData;
        private static const bitmapFire:Class = ItemInfoPanel_bitmapFire;
        private static const fireBd:BitmapData = new bitmapFire().bitmapData;
        ...
        public var buttonOpen:GarageButton;
        ...
        public var criticalDamageIcon:ItemPropertyIcon;
        public var fireIcon:ItemPropertyIcon;
        ...
        public function ItemInfoPanel()
        {
            ...
            this.buttonOpen = new GarageButton();
            ...
            this.buttonOpen.label = this.localeService.getText(TextConst.GARAGE_INFO_PANEL_BUTTON_OPEN_TEXT);
            ...
            this.criticalDamageIcon = new ItemPropertyIcon(criticalDamageBd, "hp");
            this.fireIcon = new ItemPropertyIcon(fireBd, "sec");
        ...
        public function showItemInfo(itemId:String, itemParams:ItemParams, storeItem:Boolean, itemInfo:ItemInfo=null, mountedItems:Array=null):void
        {
                    ...
                    while (i < properties.length)
                    {
                        ...
                        switch (p.property)
                        {
                            ...
                            case ItemProperty.VAMPIRE_RESISTANCE:
                                ...
                                this.visibleIcons[17] = this.vampireResistanceIcon;
                                break;
                            case ItemProperty.THUNDER_RESISTANCE:
                                ...
                                this.visibleIcons[18] = this.thunderResistanceIcon;
                                break;
                            case ItemProperty.FREEZE_RESISTANCE:
                                ...
                                this.visibleIcons[19] = this.freezeResistanceIcon;
                                break;
                            case ItemProperty.RICOCHET_RESISTANCE:
                                ...
                                this.visibleIcons[20] = this.ricochetResistanceIcon;
                                break;
                            case ItemProperty.SHAFT_RESISTANCE:
                                ...
                                this.visibleIcons[21] = this.shaftResistanceIcon;
                                break;
                            case ItemProperty.HEALING_RADUIS:
                                ...
                                this.visibleIcons[21] = this.healingRadiusIcon;
                                break;
                            ...
                            case ItemProperty.CRITICAL_DAMAGE:
                                ...
                                if (showProperties)
                                {
                                    this.criticalDamageIcon.labelText = p.value;
                                }
                                else
                                {
                                    this.criticalDamageIcon.labelText = "";
                                };
                                this.visibleIcons[23] = this.criticalDamageIcon;
                                break;
                            case ItemProperty.FIRE_TIME:
                                Main.writeVarsToConsoleChannel("GARAGE WINDOW", "ItemProperty: SHOT_FREQUENCY");
                                if (showProperties)
                                {
                                    this.fireIcon.labelText = p.value;
                                }
                                else
                                {
                                    this.fireIcon.labelText = "";
                                };
                                this.visibleIcons[24] = this.fireIcon;
                                break;
                        };
                        i++;
                    };
            ...
            else
            {
                if (this.type == ItemTypeEnum.INVENTORY)
                {
                    ...
                    if (((!(itemInfo == null)) && (!(itemInfo.multicounted))))
                    {
            ...
            if (this.buttonBuy.visible)
            {
                ...
                if ((((rank > 0) && (cost < 0)) && (!(itemId == "gift_m0"))))
                {
        ...
        private function posButtons():void
        {
            ...
            if (this.buttonBuy.visible)
            {
                ...
                if (this.type == ItemTypeEnum.INVENTORY)
                {
                    ...
                    this.buttonBuy.x = ((this.inventoryNumStepper.visible) ? ((this.inventoryNumStepper.x + this.inventoryNumStepper.width) + 10) : 10);
                    if (this.buttonOpen.visible)
                    {
                        this.buttonOpen.x = ((this.window.width - this.buttonOpen.width) - 10);
                        this.buttonOpen.y = buttonY;
                    };
                }
                else
                {
        ...
        private function inventoryNumChanged(e:Event=null):void
        {
            ...
            this.buttonBuy.setInfo(cost, rank);
            this.buttonBuy.enable = ((cost >= 0) && (rank > 0));
            if ((((rank > 0) && (cost < 0)) && (!(this.params.baseItemId == "gift_m0"))))
            {
                this.requiredCrystalsNum = (-(cost) - this.panelModel.crystal);
                this.buttonBuyCrystals.visible = true;
                this.buttonBuyCrystals.setInfo(this.requiredCrystalsNum, (this.requiredCrystalsNum * GarageModel.buyCrystalRate));
