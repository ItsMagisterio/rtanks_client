package alternativa.tanks.gui
{
    ...
    public class GarageWindow extends Sprite 
    {
        ...
        public function GarageWindow(garageBoxId:Long)
        {
            ...
            this.itemInfoPanel.buttonOpen.addEventListener(MouseEvent.CLICK, this.onOpenButtonClick);
        }
        ...
        public function resize(width:int, height:int):void
        {
            ...
            this.shopItemsWindow.width = (width - leftHeaderWidth);
            this.shopItemsWindow.height = 169;
            this.shopItemsWindow.x = leftHeaderWidth;
            this.shopItemsInner.width = ((width - (this.windowMargin * 2)) - leftHeaderWidth);
            this.shopItemsInner.height = (this.shopItemsWindow.height - (this.windowMargin * 2));
            this.shopItemsInner.x = (this.windowMargin + leftHeaderWidth);
            ...
            this.storeList.x = ((this.windowMargin + 4) + leftHeaderWidth);
        ...
        public function addItemToWarehouse(itemId:String, itemParams:ItemParams, itemInfo:ItemInfo):void
        {
            ...
            this.warehouseList.addItem(itemId, itemParams.name, itemParams.itemType.value, itemParams.itemIndex, itemParams.price, itemParams.rankId, false, true, itemInfo.count, resource, itemInfo.discount, itemParams.modifications.length, itemParams.modificationIndex, itemInfo.multicounted);
        }
        ...
        public function addItemToStore(itemId:String, itemParams:ItemParams, itemInfo:ItemInfo):void
        {
            ...
            var resource:ImageResource = (ResourceUtil.getResource(ResourceType.IMAGE, (itemId + "_preview")) as ImageResource);
            this.storeList.addItem(itemId, itemParams.name, itemParams.itemType.value, itemParams.itemIndex, itemParams.price, ((userRank >= itemParams.rankId) ? 0 : itemParams.rankId), false, false, 0, resource, itemInfo.discount, itemParams.modifications.length, 0);
        }
        ...
        public function showItemInfo(itemId:String, itemParams:ItemParams, storeItem:Boolean, itemInfo:ItemInfo=null, mountedItems:Array=null):void
        {
            ...
            if ((((itemParams.inventoryItem) && (!(storeItem))) && (itemInfo.multicounted)))
            {
        ...
        {
            dispatchEvent(new GarageWindowEvent(GarageWindowEvent.OPEN_ITEM, this.selectedItemId));
        }
