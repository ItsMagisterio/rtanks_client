package alternativa.tanks.vehicles.tanks
{
    ...
    public class TankSkin 
    {
        ...
        public function removeFromContainer():void
        {
            ...
            var _local_1:* = this._hullMesh;
            (_local_1.alternativa3d::removeFromParent());
            _local_1 = this._turretMesh;
            (_local_1.alternativa3d::removeFromParent());
        ...
        public function createTexture(colormap:BitmapData, lightmap:BitmapData, details:BitmapData):BitmapData
        {
            ...
            {
                return (new StubBitmapData(0xFF0000));
            };
            return (null);
        }
...
class SkinStateMaterials 
{
    ...
    public function SkinStateMaterials(coloring:BitmapData, hullMaterial:Material, turretMaterial:Material)
    {
