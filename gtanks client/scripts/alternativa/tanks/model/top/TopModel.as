package alternativa.tanks.model.top
{
   ...
   import projects.tanks.client.panel.model.TopModelBase;
   import projects.tanks.client.panel.model.User;
   import projects.tanks.client.users.PropertyType;
   ...
   public class TopModel extends TopModelBase implements ITopModelBase, IObjectLoadListener
   {
      ...
      private var statWindow:StatisticOfClansWindow;
      ...
      public function openTop(clientObject:ClientObject, usersCount:int, rowHeigth:int) : void
      {
         var panelModel:IPanel = null;
         Main.writeVarsToConsoleChannel("TOP MODEL","openTop usersCount: " + usersCount);
         this.usersCount = usersCount;
         this.statWindow = new StatisticOfClansWindow(rowHeigth);
