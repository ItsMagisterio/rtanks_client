package alternativa.tanks.camera
{
   ...
   public class FollowCameraController extends CameraControllerBase implements IFollowCameraController
   {
      ...
      private static const ALT_KEY_CAMERA_UP:uint = Keyboard.PAGE_UP;
      
      private static const KEY_CAMERA_DOWN:uint = Keyboard.E;
      
      private static const ALT_KEY_CAMERA_DOWN:uint = Keyboard.PAGE_DOWN;
      ...
      {
         if(this._tank == null || this._tank.skin == null || this._tank.skin.turretMesh == null)
         {
            return;
         }
