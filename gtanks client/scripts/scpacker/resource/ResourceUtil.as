...
package scpacker.resource
{
    ...
    public class ResourceUtil 
    {
        ...
        public static function getResource(_arg_1:ResourceType, key:String):Object
        {
        ...
        public static function loadResource():void
        {
            ...
            sfxMap["isidahw"] = "damagingRayId, damagingTargetBallId, damagingWeaponBallId, healingRayId, healingTargetBallId, healingWeaponBallId, idleWeaponBallId";
            sfxMap["thunder"] = "explosionResourceId, shotResourceId";
            sfxMap["bfg"] = "explosionResourceId, shotResourceId";
        ...
        public static function unloadImages(saveList:Vector.<String>=null):void
        {
            ...
            loaderImages.inbattleList.add(loaderImages.list.getImage("bonus_box_gift").clone());
            ...
            loaderImages.inbattleList.add(loaderImages.list.getImage("dom_pestal_neutral").clone());
            loaderImages.inbattleList.add(loaderImages.list.getImage("dom_pestal_red").clone());
            loaderImages.inbattleList.add(loaderImages.list.getImage("dom_pestal_blue").clone());
