package forms.battlelist
{
   ...
   public class ViewBattleList extends Sprite
   {
      ...
      public function addItem(id:Object, name:String, deathMatch:Boolean = true, reds:int = 0, blues:int = 0, all:int = 0, map:String = "", totalfull:Boolean = false, redful:Boolean = false, bluefull:Boolean = false, accessible:Boolean = true, closed:Boolean = false) : void
      {
         var data:Object = new Object();
         var item:Object = new Object();
