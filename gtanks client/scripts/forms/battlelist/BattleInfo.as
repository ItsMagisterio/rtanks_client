package forms.battlelist
{
   ...
   public class BattleInfo extends Sprite
   {
      ...
      public function setUp(gameName:String, minRang:int, maxRang:int, killLimit:int = 0, timeLimit:int = 0, currentTime:int = 0, img:BitmapData = null, IO:Boolean = false, AB:Boolean = false, FF:Boolean = false, url:String = "", CTF:Boolean = false, DOM:Boolean = false, payd:Boolean = false, inventory:Boolean = false) : void
      {
