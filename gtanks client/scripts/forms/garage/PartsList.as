package forms.garage
{
   ...
   public class PartsList extends Sprite implements IResourceLoadListener
   {
      ...
      public function addItem(id:Object, name:String, type:int, sort:int, crystalPrice:int, rang:int, installed:Boolean, garageElement:Boolean, count:int, preview:ImageResource, discount:int, maxModification:int, modification:int = 0, multicounted:Boolean = true) : void
      {
         ...
         else
         {
            this.dp.addItem({
               ...
               "typesort":data.typeSort,
               "sort":sort,
               "multicounted":data.multicounted
            });
      ...
      private function myIcon(data:Object, select:Boolean) : DisplayObject
      {
         ...
         else
         {
            ...
            switch(data.type)
            {
               ...
               case NOT_TANK_PART:
                  ...
                  if(data.id != "1000_scores_m0" && data.id != "gift_m0")
                  {
         ...
         {
            if(data.crystalPrice > 0 && data.multicounted)
            {
