package forms.stat
{
   import alternativa.tanks.gui.StatisticOfClansWindow;
   ...
   public class StatListRendererNew extends CellRenderer
   {
      ...
      public function StatListRendererNew()
      {
         super();
      }
      ...
      protected function myIcon(data:Object) : Sprite
      {
         ...
         var achiviments:Label = new Label();
         info = new Label();
         ...
         cont.addChild(name);
         achiviments.autoSize = TextFieldAutoSize.NONE;
         achiviments.align = TextFormatAlign.LEFT;
         achiviments.width = 300;
         achiviments.height = StatisticOfClansWindow.rowHeight;
         achiviments.x = 327;
         achiviments.text = _data.achiviments != null ? _data.achiviments : " ";
         cont.addChild(achiviments);
         info = new Label();
         info.autoSize = TextFieldAutoSize.NONE;
         info.align = TextFormatAlign.LEFT;
         info.width = 60;
         info.x = _width - 70;
         info.text = _data.rating > -1 ? Money.numToString(_data.rating,false) : " ";
         cont.addChild(info);
         return cont;
      }
