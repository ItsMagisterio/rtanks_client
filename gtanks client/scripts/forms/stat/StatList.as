package forms.stat
{
   ...
   public class StatList extends Sprite
   {
      ...
      public function StatList(rowHeight:int)
      {
         this.list = new List();
      ...
      public static function setBackground(_width:int, currentSort:int, _selected:Boolean) : BitmapData
      {
         ...
         var infoX:int = int(_width - 65);
         var cells:Array = [0,55,200,330,infoX,_width - 1,infoX + 130,infoX + 180,infoX + 220,infoX + 285,_width - 1];
         i = 0;
      ...
      protected function ConfigUI(e:Event) : void
      {
         ...
         this.list.rowHeight = this.rowHeight;
         this.list.setStyle("cellRenderer",StatListRendererNew);
      ...
      public function addItem(pos:int, rank:int = 0, callsign:String = "", achiviments:String = "", score:int = 0, kills:int = 0, deaths:int = 0, ratio:Number = 0, wealth:int = 0, rating:Number = 0, sort:int = 4) : void
      {
         var item:Object = new Object();
         item.pos = pos;
         item.rank = rank;
