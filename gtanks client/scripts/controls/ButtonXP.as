...
package controls
{
    ...
    public class ButtonXP extends Sprite 
    {
        ...
        private static const goldButtonRight_pressed:Class = ButtonXP_goldButtonRight_pressed;
        private static const goldButtonRight_over:Class = ButtonXP_goldButtonRight_over;
        private static const goldButtonLeft_over:Class = ButtonXP_goldButtonLeft_over;
        private static const goldButtonCenter:Class = ButtonXP_goldButtonCenter;
        private static const goldButtonCenter_pressed:Class = ButtonXP_goldButtonCenter_pressed;
        private static const goldButtonLeft:Class = ButtonXP_goldButtonLeft;
        private static const goldButtonCenter_over:Class = ButtonXP_goldButtonCenter_over;
        private static const goldButtonLeft_pressed:Class = ButtonXP_goldButtonLeft_pressed;
        private static const goldButtonRight:Class = ButtonXP_goldButtonRight;
        private static const greenCenter:Class = ButtonXP_greenCenter;
        private static const greenLeft:Class = ButtonXP_greenLeft;
        private static const greenRight:Class = ButtonXP_greenRight;
        private static const IconXP:Class = ButtonXP_IconXP;
        ...
        private var bgLeftOVER:BitmapData = new goldButtonLeft_over().bitmapData;
        private var bgCenterOVER:BitmapData = new goldButtonCenter_over().bitmapData;
        private var bgRightOVER:BitmapData = new goldButtonRight_over().bitmapData;
        private var bgLeftDOWN:BitmapData = new goldButtonLeft_pressed().bitmapData;
        private var bgCenterDOWN:BitmapData = new goldButtonCenter_pressed().bitmapData;
        private var bgRightDOWN:BitmapData = new goldButtonRight_pressed().bitmapData;
        private var bgLeftUP:BitmapData = new goldButtonLeft().bitmapData;
        private var bgCenterUP:BitmapData = new goldButtonCenter().bitmapData;
        private var bgRightUP:BitmapData = new goldButtonRight().bitmapData;
        private var bgLeftGREEN:BitmapData = new greenLeft().bitmapData;
        private var bgCenterGREEN:BitmapData = new greenCenter().bitmapData;
        private var bgRightGREEN:BitmapData = new greenRight().bitmapData;
        private var bmpL:Bitmap = new Bitmap();
        private var bmpC:Bitmap = new Bitmap();
        private var bmpR:Bitmap = new Bitmap();
        private var icon:Bitmap = new Bitmap(new IconXP().bitmapData);
        ...
        protected function setState(param1:int=0):void
        {
            switch (param1)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    this.bmpL.bitmapData = this.bgLeftGREEN;
                    this.bmpC.bitmapData = this.bgCenterGREEN;
                    this.bmpR.bitmapData = this.bgRightGREEN;
                    break;
            };
            this.draw((param1 == 0));
        }
