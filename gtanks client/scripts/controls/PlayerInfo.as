package controls
{
   ...
   public class PlayerInfo extends Sprite
   {
      ...
      public function PlayerInfo()
      {
         ...
         this.indicators.scoreLabel.addEventListener(MouseEvent.MOUSE_OVER,function(e:Event):void
         {
            Mouse.cursor = MouseCursor.BUTTON;
         });
         this.indicators.scoreLabel.addEventListener(MouseEvent.MOUSE_OUT,function(e:Event):void
         {
            Mouse.cursor = MouseCursor.ARROW;
         });
         this.indicators.scoreLabel.addEventListener(MouseEvent.CLICK,function(e:Event):void
         {
            navigateToURL(new URLRequest("http://ratings.generaltanks.com"));
         });
