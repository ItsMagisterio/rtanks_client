...
public class Auth extends AuthComandsConst {
    ...
    private static final int MIN_AES_PAYLOAD_LENGTH = 3000;
    ...
    private void handleSystem(Command command) throws Exception {
        ...
        if ("get_aes_data".equals(arg0)) {
            ...
            if (AES_DATA.length() < MIN_AES_PAYLOAD_LENGTH) {
                Logger.log("AES_DATA payload is unexpectedly short: " + AES_DATA.length());
