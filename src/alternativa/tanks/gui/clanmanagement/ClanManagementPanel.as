package alternativa.tanks.gui.clanmanagement
{
   ...
   import alternativa.tanks.gui.clanmanagement.buttons.ClanJoinRequestsButton;
   ...
   public class ClanManagementPanel extends name_649
   {
      ...
      public var var_1174:ClanJoinRequestsButton;
      
      public var var_1171:ClanTopManagementPanel;
      
      private var var_1172:ClanInfoPanel;
      
      public function ClanManagementPanel(param1:name_70)
      {
      ...
      private function init() : void
      {
         ...
         this.var_1172 = new ClanInfoPanel(this.clanObject);
         this.var_1170.name_1876(localeService.getText(name_390.const_732),this.var_1172,ClanStateButton);
         this.var_1174 = ClanJoinRequestsButton(this.var_1170.name_1876(localeService.getText(name_390.const_528),this.var_1173,ClanJoinRequestsButton));
      ...
      {
         this.var_1172.setPendingClanInfoUpdate(param1);
      ...
      public function addMemberToClan(param1:Long) : void
      {
         clanService.clanMembers.push(param1);
         this.var_1173.addUser(param1);
         this.var_1171.incrementMembersCount();
         this.var_1172.incrementMembersCount();
      }
      
      public function removeMemberFromClan(param1:Long) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            this.var_1171.decrementMembersCount();
            this.var_1172.decrementMembersCount();
         }
      }
