package package_1
{
   ...
   public class BattlefieldModelActivator implements IBundleActivator
   {
      ...
      public function start(param1:OSGi) : void
      {
         ...
         _loc3_.name_275(LaserPointer,LaserPointerAdapt);
         _loc3_.name_270(LaserPointer,LaserPointerEvents);
         ...
         _loc3_.name_275(DiscreteWeapon,DiscreteWeaponAdapt);
         _loc3_.name_270(DiscreteWeapon,DiscreteWeaponEvents);
         _loc3_.add(new DiscreteWeaponCommunicationModel(),Vector.<Class>([IDiscreteWeaponCommunicationModelBase,DiscreteWeapon]));
         _loc3_.name_275(DiscreteWeaponListener,DiscreteWeaponListenerAdapt);
         _loc3_.name_270(DiscreteWeaponListener,DiscreteWeaponListenerEvents);
         _loc3_.add(new name_283(),Vector.<Class>([name_307,name_141]));
         _loc3_.add(new name_285(),Vector.<Class>([name_293,name_170]));
         param1.name_40(class_12,LaserPointerModel,"localTankInfoService");
